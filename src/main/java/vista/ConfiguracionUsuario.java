...
public class ConfiguracionUsuario extends javax.swing.JDialog {
    ...
    public ConfiguracionUsuario(Principal principal, boolean modal, Employee employee) {
    ...
    private void lblAceptarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAceptarMouseClicked
        ...
        try {
            ...
            principal.employeeApiCall.updateEmployee(employee);
